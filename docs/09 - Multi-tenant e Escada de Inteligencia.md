...
| N6 | Escalar/aprovacao + virar regra | **PENDENTE (IA Fatias 3-4)** | ai_decisions, Sender | pending_approvals, /revisao, promotor de regra |
...
|---|---|---|---|---|---|
| 1 | **IA-3** Fila de aprovacao | `pending_approvals` + /revisao (Enviar/Editar/Ignorar); escalou vira item acionavel | — | Baixo | Testar aprovar/editar/ignorar num contato real |
